...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/chaching_Icon.png
  AssetGenImage get chachingIcon => const AssetGenImage('assets/images/chaching_Icon.png');
  ...
  /// File path: assets/images/dollar_icon.png
  AssetGenImage get dollarIcon => const AssetGenImage('assets/images/dollar_icon.png');

  /// File path: assets/images/dotted.png
  AssetGenImage get dotted => const AssetGenImage('assets/images/dotted.png');

  /// File path: assets/images/facebook-2.svg
  String get facebook2 => 'assets/images/facebook-2.svg';
  ...
  /// File path: assets/images/gift_box.jpg
  AssetGenImage get giftBox => const AssetGenImage('assets/images/gift_box.jpg');

  /// File path: assets/images/gift_winner.svg
  String get giftWinner => 'assets/images/gift_winner.svg';

  /// File path: assets/images/give_away_iphone.jpg
  AssetGenImage get giveAwayIphone => const AssetGenImage('assets/images/give_away_iphone.jpg');

  /// File path: assets/images/google-icon.svg
  String get googleIcon => 'assets/images/google-icon.svg';
  ...
  AssetGenImage get house => const AssetGenImage('assets/images/house.jpeg');

  /// File path: assets/images/ic_chaching_icon.png
  AssetGenImage get icChachingIcon => const AssetGenImage('assets/images/ic_chaching_icon.png');
  ...
  /// File path: assets/images/onboarding_step_1.svg
  String get onboardingStep1 => 'assets/images/onboarding_step_1.svg';
