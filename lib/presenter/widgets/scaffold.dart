...
class PositionedPokeball extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(
      top: pokeballTopMargin + 25,
      right: PokedexApp.of(context)?.local == Locale("ar") ? - 3*pokeballRightMargin : pokeballRightMargin,
      child: Image(
        image: Assets.images.icChachingIcon.provider(),
        width: pokeballSize,
        height: pokeballSize,
